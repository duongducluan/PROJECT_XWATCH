...
import {getDataAccesories} from '../../../actions/index';
import {NavLink} from "react-router-dom";
class MainRight extends Component {
    componentDidMount(){
        this.props.fetchAllProducts('oclockaccesories');
    }
    render() {
...
const mapDispatchToProps=(dispatch)=>{
    return{
        fetchAllProducts:(oclockaccesories)=>{
            dispatch(getDataAccesories(oclockaccesories))
        }
    }
}

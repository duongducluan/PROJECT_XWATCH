...
import { getItemProductAccesories} from '../../actions/index';
import {connect} from 'react-redux';
class LeftShow extends Component {
     componentDidMount(){
    var {id}=this.props.match.params
        this.props.getItem(id,'oclockaccesories') ;
}
    render() {
...
const mapDispatchToProps=(dispatch)=>{
    return{
        getItem:(id,oclockaccesories)=>{
            dispatch(getItemProductAccesories(id,oclockaccesories))
        }
    }
}

...
import ContendLeft from "./../components/OlockEvaluations/Contend/ContendLeft";
import ContendRight from "./../components/OlockEvaluations/Contend/ContendRight";
...
class ClockEvaluation extends Component {
  render() {
    return (
      <div>
        <Header />
...
export default ClockEvaluation;